            ...
            <View style={{ flex: 1, backgroundColor: colors.card }}>
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    >
                        ...
                        <View>
                            <Text style={{ ...FONTS.h5, color: colors.title, marginBottom: 4 }}>Deepesh Gour</Text>
                            <Text style={{ ...FONTS.font, color: colors.textLight, opacity: .9, marginBottom: 2 }}>deepeshgour123@gmail.com</Text>
                        </View>
                    </View>
                    ...
                    >
                        <Text style={{ ...FONTS.h6, ...FONTS.fontTitle, color: colors.title, marginBottom: 4 }}>classifind</Text>
